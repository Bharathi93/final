...
<div className="col-sm-9">
  ...
  <div class="list-group-item">
    ...
    <a href={this.state.id} role="button" className="btn btn-warning" data-toggle="modal">
								Update
							</a>
						<div className="modal fade" id={this.props.fdetail.imdbID}>
											...
											<form className="form-horizontal">
												<div className="form-group">
													...
													<div className="col-lg-10">
														<input className="form-control" ref="inputMovie" placeholder={this.props.fdetail.Title} type="text"/>
													</div>
												</div>
												...
												<div className="form-group">
													...
													<div className="col-lg-10">
														<input className="form-control" id="inputYear" placeholder={this.props.fdetail.Year} type="text"/>
													</div>
												</div>
